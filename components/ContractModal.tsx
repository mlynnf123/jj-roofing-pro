...
const getInitialContractDetails = (lead: Lead, rep: ContractModalProps['defaultCompanyRep']): ContractDetails => {
  return {
    ...
    initialsConstructionSiteCaution: "",
    initialsDrivewayUsage: "",
    initialsPuncturedLines: "",
    initialsTermsOnReverseSide: "",
    initialsRightOfRescissionConfirmation: "",
    initialsDisclosureConfirmation: "",
